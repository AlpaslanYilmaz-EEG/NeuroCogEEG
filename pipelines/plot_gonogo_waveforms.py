"""
Go/No-Go waveform figure pipeline for NeuroCogEEG.

This script creates group-level grand-average ROI waveform figures for Go/No-Go.
...
Outputs:
outputs/gonogo/figures/waveforms/
outputs/qc/gonogo_waveform_manifest.csv
"""
    ...
    return [
        {
            ...
            "roi": n2["roi"],
            "window": n2["window"],
            "title": "Go/No-Go stimulus-locked N2 ROI",
            "filename": "gonogo_stimulus_locked_n2_roi.png",
        },
        {
            ...
            "roi": p3["roi"],
            "window": p3["window"],
            "title": "Go/No-Go stimulus-locked P3 ROI",
            "filename": "gonogo_stimulus_locked_p3_roi.png",
        },
        {
            ...
            "roi": rp["roi"],
            "window": rp["window"],
            "title": "Go/No-Go response-locked RP ROI",
            "filename": "gonogo_response_locked_rp_roi.png",
        },
        {
            ...
            "roi": pmp["roi"],
            "window": pmp["window"],
            "title": "Go/No-Go response-locked PMP ROI",
            "filename": "gonogo_response_locked_pmp_roi.png",
        },
    ]
...
def save_all_waveform_plots(waveform_store, plot_specs):
    output_dir = PROJECT_ROOT / "outputs" / "gonogo" / "figures" / "waveforms"
...
def write_manifest(rows):
    ...
    output_path = PROJECT_ROOT / "outputs" / "qc" / "gonogo_waveform_manifest.csv"
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def main():
    ...
    if not subjects:
        print("Go/No-Go EDF dosyası bulunamadı.")
        return
    ...
    print("")
    print("Go/No-Go waveform grafikleri tamamlandı.")
