"""
Go/No-Go analysis pipeline for NeuroCogEEG.
...
def empty_connectivity_results(
    ...
    ----------
    connectivity_config:
        Connectivity section from gonogo.yaml.
...
def compute_behavioral_results(
    ...
    """
    Compute Go/No-Go behavioral outcomes.
...
def compute_response_locked_results(
    ...
    added when defined in gonogo.yaml.
    """
...
def compute_connectivity_results(
    ...
    """
    Compute Go/No-Go connectivity results.
...
def process_subject(
    ...
    experiment_config:
        Loaded Go/No-Go experiment configuration.
...
def run_pipeline() -> Path | None:
    """
    Run the Go/No-Go pipeline for all available participants.
    ...
    save_config_snapshot(
        ...
        output_path=dataset.reports_dir / "used_gonogo_config.yaml",
    )
    ...
    output_path = dataset.csv_dir / "gonogo_results.csv"
